const translations = {
    en: {
        ...
        education_thesis1: "Scientific initiation program: Galvanometer usage in laser harp electronics.",
        education_thesis2: "Thesis: Comparative study of A* pathtracing algorithm vs. machine learning genetic algorithm on warehouse robots automation.",
        education_thesis3: "Thesis: Newstand sales software automation.",
    ...
    pt: {
        ...
        education_thesis1: "Programa de iniciação científica: utilização de galvanômetro como componente eletrônico em harpas laser.",
        education_thesis2: "Tese: Estudo comparativo do algoritmo de rastreamento de caminho A* versus algoritmo genético de aprendizado de máquina na automação de robôs de armazém.",
        education_thesis3: "Tese: Software empregado em automação de bancas de jornais.",
